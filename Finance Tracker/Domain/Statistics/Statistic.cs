...
public class Statistic
{
    ...
    private Statistic(decimal minusSum, int minusCoutTransaction, int minusCoutCategory, decimal plusSum, int plusCoutTransaction, int plusCoutCategory)
    {
        MinusSum = minusSum;
    ...
    public static Statistic New(decimal minusSum, int minusCoutTransaction, int minusCoutCategory, decimal plusSum, int plusCoutTransaction, int plusCoutCategory)
